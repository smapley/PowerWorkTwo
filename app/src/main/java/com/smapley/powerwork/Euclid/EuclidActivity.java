...
//        mOverlayListItemView.findViewById(R.id.view_avatar_overlay).setBackgroundResource(R.drawable.main_backgound);
        getBitmap.getBitmap(item.get(EuclidListAdapter.KEY_PIC).toString(), ((ImageView) mOverlayListItemView.findViewById(R.id.image_view_reveal_avatar)));
        getBitmap.getBitmap(item.get(EuclidListAdapter.KEY_PIC).toString(), ((ImageView) mOverlayListItemView.findViewById(R.id.image_view_avatar)));
//
//        ((ImageView) mOverlayListItemView.findViewById(R.id.image_view_reveal_avatar)).setImageResource((Integer) item.get(EuclidListAdapter.KEY_PIC));
//        ((ImageView) mOverlayListItemView.findViewById(R.id.image_view_avatar)).setImageResource((Integer) item.get(EuclidListAdapter.KEY_PIC));
    ...
    private Animator getAvatarShowAnimator(int profileDetailsAnimationDelay) {
        final Animator mAvatarShowAnimator = ObjectAnimator.ofFloat(mOverlayListItemView, View.Y, mOverlayListItemView.getTop(), 50);
